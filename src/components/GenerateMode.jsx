...
import { C, pageWrap, card, h1, h2, primaryBtn, chipBtn, chipBtnActive } from "../constants";
import { DECK_MAP } from "../data/questions";
import { generatedStore, passcodeStore } from "../utils/storage";
...
async function generateQuestions({ file, pastedText, deck, category, year, block, difficulty, count }) {
  ...
  const res = await fetch("/api/generate", {
    ...
    headers: {
      ...
      "x-ascend-passcode": passcodeStore.get(),
    },

...
export function Sidebar({ view, setView, dueCount, wrongCount, pomodoro }) {
  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <img src="/logo.png" alt="Resurface" style={{
      ...
      <div style={{ padding: "12px 20px", borderTop: "1px solid var(--c-nav-border)" }}>
        <div style={{ color: NAV_MUTDIM, fontSize: 12, letterSpacing: 0.2 }}>© Resurface 2026</div>
      </div>
    </aside>
  );
}
